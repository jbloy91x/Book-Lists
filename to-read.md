...
Books to read next. Source tracks where each pick came from: Skippy's recommendations or Josh's own picks. Remove a row when the book moves into the reading log.
...
| The Hero with a Thousand Faces | Josh | Joseph Campbell's mythology classic, 1949 |
...
| Shantaram | Skippy | Gritty, voice-driven; next to Kitchen Confidential on your shelf |
| Shogun | Skippy | Epic historical, feudal Japan |
| The Last Kingdom | Skippy | Bernard Cornwell, Saxon Stories #1 |
| The Pillars of the Earth | Skippy | Epic historical doorstopper |
| Prince of Thorns | Skippy | Grimdark; Abercrombie/Stover speed |
| The Emperor's Blades | Skippy | Old-school epic fantasy |
